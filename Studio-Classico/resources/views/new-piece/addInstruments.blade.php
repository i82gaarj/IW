    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
				...
				<form method="POST" action="{{ route('new-piece.add-instrument-post') }}">
                        @csrf
                    ...
                    @if ($instruments_session != null)
                        @foreach($instruments_session as $instrument)
                            ...
                            <form class="my-3" action="{{route('new-piece.delete-instrument-post')}}" method="post">
                                @csrf
                    ...
                    <button class="btn btn-primary" onclick='window.location.href = "{{route('new-piece.upload-score-get')}}"'>Siguiente</button>
                </div>
            </div>
        </div>
    </div>
