    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
				...
				<form method="POST" action="{{ route('new-piece.basic-data-post') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <label for="author" class="col-md-4 col-form-label text-md-end">{{ __('Compositor') }}</label>
						...
						<div class="row mb-3">
                            <label for="duration" class="col-md-4 col-form-label text-md-end">{{ __('Duración (en segundos)') }}</label>
